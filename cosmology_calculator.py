...
# comoving volume computation
  ...
  if verbose == 1:
    ...
    # print '%1.2f' % zage_Gyr,
    # print '%1.2f' % DCMR_Mpc,
    DL_Mpc_metres = DL_Mpc * 3.086e22
    print '%1.3f' % kpc_DA + '\t' + '%1.0f' % DL_Mpc_metres  # kpc/asec and luminosity distance in metres
    # print '%1.2f' % (5*log10(DL_Mpc*1e6)-5)

except IndexError:
  print 'need some values or too many values, you dimwit!'
except ValueError:
  print 'nonsense value or option, you numbskull!'
